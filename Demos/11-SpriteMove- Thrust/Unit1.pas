...
var
SpriteGabriel: SE_Sprite;
begin
  SpriteGabriel:= SE_Characters.FindSprite('gabriel');
  if Key ='a' then  begin

  SpriteGabriel.MoverData.UseThrust:= True;
  SpriteGabriel.MoverData.fThrust := 0.3;
  SpriteGabriel.MoverData.FFriction := 0.1;
  SpriteGabriel.MoverData.FMaximumSpeed := 8;
  end
  else begin
  SpriteGabriel.MoverData.fThrust := 0;
  end;
end;
