...
begin
   ...
   for I := 0 to 9 do begin
     ...
     SpriteBuff := SE_SubSprite.create('..\!media\buff1.bmp','buff1',32,0,True,true,1,0);
     Sprite.SubSprites.Add(Spritebuff);
     SpriteBuff := SE_SubSprite.create('..\!media\buff2.bmp','buff2',50,0,True,true,1,0);
     Sprite.SubSprites.Add(Spritebuff);
   ...
   for I := 0 to 9 do begin
     ...
     SpriteBuff := SE_SubSprite.create('..\!media\buff3.bmp','buff3',32,0,True,true,1,0);
     Sprite.SubSprites.Add(Spritebuff);
     SpriteBuff := SE_SubSprite.create('..\!media\buff4.bmp','buff4',50,0,True,true,1,0);
     Sprite.SubSprites.Add(Spritebuff);
