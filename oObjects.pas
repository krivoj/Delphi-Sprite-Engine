...
type
  ...
  public
    ...
    procedure FreeItem(Item: PAnsiChar); virtual;
    destructor Destroy; override;
  end;

  TNoOwnerCollection = class(TOCollection)
  public
    procedure FreeItem(Item: PAnsiChar); override;
  end;
  ...
  public
    Duplicates: Boolean;
    constructor Create(ACapacity: Integer);
    function Compare(Key1, Key2: PAnsiChar): Integer; virtual; abstract;
...
procedure TOCollection.FreeItem(Item: PAnsiChar);
begin
  if (Item <> nil) then
...
procedure TNoOwnerCollection.FreeItem(Item: PAnsiChar);
begin
end;
...
function TStrCollection.Compare(Key1, Key2: PAnsiChar): Integer;
begin
  Compare := StrComp(Key1, Key2);
end;

procedure TStrCollection.FreeItem(Item: PAnsiChar);
begin
  StrDispose(Item);
end;
